package nanosoft.azhar.me.streetviewdemo01;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                StreetView streetView = new StreetView.Builder("AIzaSyDCRdnf4GW14NtTGA7YdTcYPu9AWEMuj-U")
                        .pitch("-0.76")
                        .heading("80.0")
                        .size("600x450")
                        .fov("90")
                ...
                streetView.getStreetView(23.791081, 90.425064, new CallBack() {
                    @Override
